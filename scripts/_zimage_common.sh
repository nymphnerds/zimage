...
ZIMAGE_OPENROUTER_ENV_FILE="${ZIMAGE_OPENROUTER_ENV_FILE:-$ZIMAGE_CONFIG_DIR/openrouter.env}"
...
ZIMAGE_LORA_ROOT="${ZIMAGE_LORA_ROOT:-$HOME/LoRA/loras}"
...
ZIMAGE_NUNCHAKU_COMMIT="${ZIMAGE_NUNCHAKU_COMMIT:-b092d6904f6ace0cc6fa65f3ac0beb1cf257ac40}"
...
Z_IMAGE_DEFAULT_CONTROLNET_REPO="alibaba-pai/Z-Image-Turbo-Fun-Controlnet-Union-2.1"
Z_IMAGE_DEFAULT_CONTROLNET_FILE="Z-Image-Turbo-Fun-Controlnet-Union-2.1-2602-8steps.safetensors"
...
export Z_IMAGE_NUNCHAKU_RANK="${preset_rank:-${Z_IMAGE_NUNCHAKU_RANK:-32}}"
export Z_IMAGE_NUNCHAKU_PRECISION="${preset_precision:-${Z_IMAGE_NUNCHAKU_PRECISION:-auto}}"
export Z_IMAGE_NUNCHAKU_IMG2IMG="${Z_IMAGE_NUNCHAKU_IMG2IMG:-1}"
export Z_IMAGE_CONTROLNET_REPO="${Z_IMAGE_CONTROLNET_REPO:-$Z_IMAGE_DEFAULT_CONTROLNET_REPO}"
export Z_IMAGE_CONTROLNET_FILE="${Z_IMAGE_CONTROLNET_FILE:-$Z_IMAGE_DEFAULT_CONTROLNET_FILE}"
...
export ZIMAGE_OPENROUTER_ENV_FILE
export ZIMAGE_CONFIG_DIR
export ZIMAGE_LORA_ROOT
